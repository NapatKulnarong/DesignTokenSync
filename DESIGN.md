...
primary-foreground-light: "{blue.50}"
secondary-light: "{gray.800}"
secondary-foreground: "{gray.100}"
accent-light: "{mint.300}"
accent-foreground-light: "{mint.800}"
destructive: "{red.500}"
...
color-sidebar/border-light: "{base.black}"
color-sidebar/ring: "{mint.300}"
primary-subtle-light: "{opacity.primary.10}"
secondary-subtle: "{opacity.gray.300.20}"
accent-subtle-light: "{opacity.accent.40}"
destructive-subtle-light: "{opacity.destructive.20}"
card-low-light: "#F9FAFC"
warning-foreground: "{yellow.900}"
warning-subtle: "{opacity.warning.30}"
warning: "{yellow.400}"
success-foreground: "{green.50}"
success-subtle-light: "{opacity.success.20}"
purple-subtle-light: "{opacity.purple.20}"
purple-foreground: "{purple.50}"
purple: "{purple.500}"
primary-outline-light: "{opacity.primary.70}"
secondary-outline-light: "{opacity.secondary.70}"
destructive-outline: "{opacity.destructive.70}"
accent-outline-light: "{opacity.accent.70}"
...
warning-subtle-foreground-light: "{yellow.600}"
color-sidebar/sidebar-hover: "{gray.800}"
card-high: "{muted}"
brown-light: "{brown.700}"
brown-foreground: "{brown.50}"
brown-subtle-light: "{opacity.brown.20}"
brown-outline-light: "{opacity.brown.70}"
transparent: "#FFFFFF"
inverse-light: "{base.black}"
inverse-foreground-light: "{base.white}"
...
inverse-outline-light: "{opacity.gray.900.70}"
color-appbar/appbar-muted-foreground: "{gray.400}"
color-hover/primary-hover-light: "{opacity.primary.80}"
color-hover/primary-subtle-hover-light: "{opacity.primary.20}"
color-hover/destructive-hover: "{opacity.destructive.80}"
color-hover/destructive-subtle-hover-light: "{opacity.destructive.30}"
color-hover/accent-hover-light: "{opacity.accent.80}"
color-hover/accent-subtle-hover-light: "{opacity.accent.50}"
color-hover/inverse-hover-light: "{opacity.gray.900.80}"
inverse-subtle: "{opacity.gray.300.20}"
color-hover/inverse-subtle-hover: "{opacity.gray.300.30}"
color-hover/secondary-hover-light: "{gray.900}"
...
color-hover/success-subtle-hover-light: "{opacity.success.30}"
color-hover/warning-subtle-hover-light: "{opacity.warning.30}"
color-hover/purple-subtle-hover-light: "{opacity.purple.30}"
color-hover/brown-subtle-hover-light: "{opacity.brown.30}"
```
...
```yaml
background-dark: "{base.black}"
foreground-dark: "{base.white}"
muted-dark: "#121723"
muted-foreground-dark: "{gray.400}"
card-dark: "{gray.900}"
popover-dark: "{base.black}"
border-dark: "{gray.700}"
input-dark: "{gray.700}"
primary-dark: "{mint.300}"
primary-foreground-dark: "{mint.800}"
secondary-dark: "{gray.600}"
secondary-foreground: "{gray.100}"
accent-dark: "{blue.500}"
accent-foreground-dark: "{blue.50}"
destructive: "{red.500}"
destructive-foreground: "{red.50}"
ring: "{blue.400}"
success: "{green.600}"
...
color-sidebar/accent: "{gray.900}"
color-sidebar/accent-foreground: "{mint.300}"
color-sidebar/border-dark: "{gray.800}"
color-sidebar/ring: "{mint.300}"
primary-subtle-dark: "{opacity.accent.30}"
secondary-subtle: "{opacity.gray.300.20}"
accent-subtle-dark: "{opacity.primary.40}"
destructive-subtle-dark: "{opacity.destructive.30}"
card-low-dark: "#121723"
warning-foreground: "{yellow.900}"
warning-subtle: "{opacity.warning.30}"
warning: "{yellow.400}"
success-foreground: "{green.50}"
success-subtle-dark: "{opacity.success.30}"
purple-subtle-dark: "{opacity.purple.40}"
purple-foreground: "{purple.50}"
purple: "{purple.500}"
primary-outline-dark: "{opacity.accent.70}"
secondary-outline-dark: "{opacity.gray.300.95}"
destructive-outline: "{opacity.destructive.70}"
accent-outline-dark: "{opacity.primary.70}"
success-outline: "{opacity.success.70}"
warning-outline: "{opacity.warning.70}"
purple-outline: "{opacity.purple.70}"
orange: "{orange.500}"
orange-subtle: "#F97316"
orange-foreground: "{orange.50}"
warning-subtle-foreground-dark: "{yellow.500}"
color-sidebar/sidebar-hover: "{gray.800}"
card-high: "{muted}"
brown-dark: "{brown.500}"
brown-foreground: "{brown.50}"
brown-subtle-dark: "{opacity.brown.60}"
brown-outline-dark: "{opacity.brown.95}"
transparent: "#FFFFFF"
inverse-dark: "{base.white}"
inverse-foreground-dark: "{base.black}"
color-sidebar/sidebar-foreground: "{gray.300}"
color-sidebar/sidebar-active: "{gray.800}"
color-sidebar/divider: "{gray.800}"
color-sidebar/sidebar-active-foreground: "{base.white}"
skeleton-dark: "{gray.800}"
color-appbar/appbar: "{base.black}"
color-appbar/appbar-hover: "{gray.800}"
color-appbar/appbar-foreground: "{gray.200}"
color-appbar/appbar-active: "{gray.800}"
...
color-appbar/appbar-accent-foreground: "{mint.300}"
color-appbar/appbar-border: "{gray.800}"
inverse-outline-dark: "{opacity.gray.300.95}"
color-appbar/appbar-muted-foreground: "{gray.400}"
color-hover/primary-hover-dark: "{opacity.accent.80}"
color-hover/primary-subtle-hover-dark: "{opacity.accent.40}"
color-hover/destructive-hover: "{opacity.destructive.80}"
color-hover/destructive-subtle-hover-dark: "{opacity.destructive.40}"
color-hover/accent-hover-dark: "{opacity.primary.80}"
color-hover/accent-subtle-hover-dark: "{opacity.primary.50}"
color-hover/inverse-hover-dark: "{opacity.gray.300.95}"
inverse-subtle: "{opacity.gray.300.20}"
color-hover/inverse-subtle-hover: "{opacity.gray.300.30}"
color-hover/secondary-hover-dark: "{gray.700}"
color-hover/secondary-subtle-hover: "{opacity.gray.300.30}"
color-hover/warning-hover: "{opacity.warning.80}"
color-hover/success-hover: "{opacity.success.80}"
color-hover/purple-hover: "{opacity.purple.80}"
color-hover/brown-hover: "{opacity.brown.80}"
color-hover/success-subtle-hover-dark: "{opacity.success.40}"
color-hover/warning-subtle-hover-dark: "{opacity.warning.40}"
color-hover/purple-subtle-hover-dark: "{opacity.purple.50}"
color-hover/brown-subtle-hover-dark: "{opacity.brown.70}"
```
